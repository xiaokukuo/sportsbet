...
public class ANSIMacBySms4Utils {
    ...
    public static void main(String[] args) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        String data = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><Message><Head><PlatDate>0</PlatDate><PlatTrace>0</PlatTrace><RetCode>????</RetCode><RetMsg>交易失败</RetMsg></Head></Message> ";

           String s =  getMac99(key,data);
